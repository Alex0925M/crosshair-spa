  ...
  const sendEmail = async (e: React.FormEvent) => {
    ...
    try {
      if (form.current) {
        ...
        // VocÃª precisarÃ¡ configurar estes valores no EmailJS
        ...
        <div className="container mx-auto px-6">
          <div className="text-center">
            <p className="text-white font-semibold text-sm md:text-base uppercase tracking-wider">
              NO VOC â€¢ 100% GREEN â€¢ GERM AND VIRUS KILLER ON CONTACT â€¢ INTERIOR & EXTERIOR
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-black text-white py-16">
        <div className="container mx-auto px-6">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center">
            <p className="text-gray-400 text-sm">Â© 2025 Crosshair Solutions. All Rights Reserved.</p>
          </div>
        </div>
      </footer>
    </div>
